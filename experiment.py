...
def helper_for_part_6(video_name, fps, frame_ids, output_prefix,
                            counter_init, is_part6, my_video):
    ...
    sr_video = os.path.join(VID_DIR, my_video)
    sr_image_gen = ps3.video_frame_generator(sr_video)

    sr_image = sr_image_gen.__next__()
    h1, w1, d1 = sr_image.shape
    ...
    while image is not None:
        ...
        dst_image = cv2.resize(sr_image, (w,h))
...
##        cv2.waitKey(0)
        ...
        src_points = ps3.get_corners_list(dst_image)

        markers = ps3.find_markers(image, template)

        if is_part6:
            homography = ps3.find_four_point_transform(src_points, markers)
            image = ps3.project_imageA_onto_imageB(dst_image, image, homography)
...
def part_1():
    ...
    input_images = ['sim_clear_scene.jpg', 'sim_noisy_scene_1.jpg',
                    'sim_noisy_scene_2.jpg']#,'simple_rectangle.png',
                   # 'simple_rectangle_noisy.png', 'simple_rectangle_noisy_gaussian.png']
    output_images = ['ps3-1-a-1.png', 'ps3-1-a-2.png', 'ps3-1-a-3.png']#,
                     #'ps3-1-a-4.png'
 #                    , 'ps3-1-a-5.png', 'ps3-1-a-6.png' ]
...
def part_2():
    ...
    output_images = ['ps3-2-a-1.png', 'ps3-2-a-2.png', 'ps3-2-a-3.png',
                     'ps3-2-a-4.png', 'ps3-2-a-5.png']#, 'ps3-2-a-6.png',
                    # 'ps3-2-a-7.png', 'ps3-2-a-8.png']
...
def part_6():
    ...
    helper_for_part_6(video_file, fps, frame_ids, "ps3-6-a", 4, True, my_video)
